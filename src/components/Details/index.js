            ...
            <div className="title-container">
              <div>
                ...
                <div className="nft-review">
                  <IconLabelWrapper>
                    <ItemsIcon />
                    <span>{nftItem?.totalSupply} {t("item")}{nftItem?.totalSupply <= 1 ? '' : 's'}</span>
                  </IconLabelWrapper>
                  <IconLabelWrapper className="owned-by" onClick={() => setIsOwnedModal(true)}>
                    <UserListIcon />
                    <span>{nftItem?.holderCount} {t("owner")}{nftItem?.holderCount <= 1 ? '' : 's'}</span>
                  </IconLabelWrapper>
                  <IconLabelWrapper>
                    ...
                    <span>{myFavorite?.count} {t("favorite")}{myFavorite?.count <= 1 ? '' : 's'}</span>
                  </IconLabelWrapper>
                </div>
              </div>
                  ...
                  <div className="button-group">
                    {
                      saleInfo?.seller.toLowerCase() !== wallet.address.toLowerCase() ?
                        ...
                        <>
                          <div className='nft-owner'>{t("You are the seller of this sale")}</div>
                          {
                            isEndedSale === true && (
                              <GradientButton
