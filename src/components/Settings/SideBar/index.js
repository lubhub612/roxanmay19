    ...
    <SideBarContainer>
      <SideToggleBar>
        ...
        <div style={{ padding: isOpenSideMenu ? "10px" : "5px" }}>
          ...
          <div
            className={activeSection === SettingPageSections.referral ? "notifications-sharp active" : "notifications-sharp"}
            onClick={() => handleActiveSection(SettingPageSections.referral)}
          >
            <HyperTooltip text="Notifications">
              <AlramSharpIcon />
            </HyperTooltip>
            {isOpenSideMenu && (
              <SideBarLabel>{t("Referral")}</SideBarLabel>
            )}
          </div>
          <div
