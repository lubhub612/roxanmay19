...
const ActivitySection = () => {
  ...
  const activityList = [
    { id: 1, event: 'List', item: 'Joana Bruers', price: '0.33', quantity: '10', from: 'ROXAN', to: '2899FaA..', time: '1 hour ago' },
    { id: 2, event: 'List', item: 'Joana Bruers', price: '0.33', quantity: '10', from: 'ROXAN', to: '2899FaA..', time: '1 hour ago' },
    { id: 3, event: 'List', item: 'Joana Bruers', price: '0.33', quantity: '10', from: 'ROXAN', to: '2899FaA..', time: '1 hour ago' },
    { id: 4, event: 'List', item: 'Joana Bruers', price: '0.33', quantity: '10', from: 'ROXAN', to: '2899FaA..', time: '1 hour ago' },
    { id: 5, event: 'List', item: 'Joana Bruers', price: '0.33', quantity: '10', from: 'ROXAN', to: '2899FaA..', time: '1 hour ago' },
    { id: 6, event: 'List', item: 'Joana Bruers', price: '0.33', quantity: '10', from: 'ROXAN', to: '2899FaA..', time: '1 hour ago' },
    { id: 7, event: 'List', item: 'Joana Bruers', price: '0.33', quantity: '10', from: 'ROXAN', to: '2899FaA..', time: '1 hour ago' },
  ]
      ...
      case 'ROXAN':
        return (
          <div className="price-div">
            <img src={theme.images.chainTokenIcon} alt='ROXAN' />
